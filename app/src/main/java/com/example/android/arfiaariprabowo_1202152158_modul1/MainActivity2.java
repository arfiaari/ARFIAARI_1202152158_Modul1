package com.example.android.arfiaariprabowo_1202152158_modul1;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast toast = null;
        if (price < 65000){
            toast = Toast.makeText(getApplicationContext(), "Didieu waeh dahar peutingna",Toast.LENGTH_SHORT);
        }else{
            toast = Toast.makeText(getApplicationContext(), "Mahal bener, jan dimari makan malemnya",Toast.LENGTH_SHORT);
        }
        toast.show();
